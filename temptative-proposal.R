...
years <- c(2008, 2011, 2014, 2017, 2020)
...
fwrite(final_dt, file = paste0("output/compare-model/", rif_var, "_final_dt.csv"))

sink(paste0("output/compare-model/", rif_var, "_temptative_multi.txt"))
print("################## MAIN MODEL ###################")
print(final_dt)
sink()

sink(paste0("output/compare-model/", rif_var, "_temptative.txt"))
