...
for (i in 1:5) {
    ...
    model[[i]] <- glmer(
        rentsbi ~ factor(wave) + hsize + head_gendr + age + edu_ref + quintile.rwealth + quintile.fwealth.gwealth + quintile.gincome + class +
            (1 + quintile.rwealth + quintile.fwealth + quintile.gincome | sa0100) + (1 | sa0100:wave),
