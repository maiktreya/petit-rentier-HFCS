...
for (i in 1:5) {
    ...
    model[[i]] <- glmer(
        rentsbi20 ~ factor(wave) + hsize + head_gendr + age_ref + edu_ref + homeown + otherpN + quintile.rwealth + quintile.fwealth + quintile.gincome + class + (1 | sa0100) + (1 | sa0100:wave),
